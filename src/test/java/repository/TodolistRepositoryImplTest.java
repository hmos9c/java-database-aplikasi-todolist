...
public class TodolistRepositoryImplTest {
  ...
  @Test
  void testGetAll() {
    todoListRepository.add(new Todolist("Sanas"));
    todoListRepository.add(new Todolist("Febriyan"));
    todoListRepository.add(new Todolist("hmos9c"));
